Agent/DBR set sport_        0
Agent/DBR set dport_        0

puts "DBR configuration file"

# ======================================================================

proc create-dbr-routing-agent { node id } {
...
proc dbr-create-mobile-node { id args } {
	...
	#
	create-dbr-routing-agent $node $id
